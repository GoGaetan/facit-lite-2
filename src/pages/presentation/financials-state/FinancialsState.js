...
import { financialFormat } from '../../../helpers/helpers';
			...
			<SubHeader>
				<SubHeaderLeft>
					...
					<div className='text-muted'>
						<small>
							{data.Wallet != null ? data.Wallet.Currency.CurrencyCode : '$'}:{' '}
							<span className='text-info fw-bold'>
								{data.Wallet != null
									? financialFormat(data.Wallet.LastTransaction.Amount)
									: '0'}
							</span>
						</small>
					</div>
